...
# shape: (450,) Wykorzystując klasę KNeighborsClassifier z pakietu scikit-learn zbuduj model klasyfikacji
# wieloklasowej. Wyucz model na danych treningowych i następnie dokonaj oceny na danych testowych. Dokładność modelu
# wyświetl do konsoli tak jak pokazano poniżej.
...
print(f'KNN accuracy: {model.score(X_test, y_test):.4f}')