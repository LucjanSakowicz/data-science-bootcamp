...
# target_train. Wykorzystano klasę TfidfVectorizer z pakietu scikit-learn do wektoryzacji tekstu i przypisano do
...
data_train = pd.read_csv('data_train_92.csv')
target_train = pd.read_csv('target_train_92.csv')
